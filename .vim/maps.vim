...
" Having longer updatetime (default is 4000 ms = 4 s) leads to noticiable
...
" position. Coc only does snippet and additional edit on confirm. <cr> could
" be remapped by other vim plugin, try `:verbose imap <CR>`.
